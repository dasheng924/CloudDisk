...
// 配置文件
#define CONF_PATH "/Users/sunguosheng/Code/Yun/Pan/conf/cfg.json"
// 存放文件类型图片目录
#define TYPE_PATH "/Users/sunguosheng/Code/Yun/Pan/conf/fileType"
// 用户文件上传下载记录
#define RECOEDDIR "/Users/sunguosheng/Code/Yun/Pan/conf/record/"

#define CONFFILE        "/Users/sunguosheng/Code/YunDisk/conf/cfg.json"     // 配置文件
#define RECORDDIR       "/Users/sunguosheng/Code/Yun/Pan/conf/record/"      // 用户文件上传下载记录
#define FILETYPEDIR     "/Users/sunguosheng/Code/Yun/Pan/conf/fileType/"     // 存放文件类型图片目录
